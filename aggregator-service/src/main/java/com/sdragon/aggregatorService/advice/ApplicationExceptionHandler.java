package com.sdragon.aggregatorService.advice;

import com.sdragon.aggregatorService.exceptions.CustomerNotFoundException;
import com.sdragon.aggregatorService.exceptions.InvalidTradeRequestException;
...
public class ApplicationExceptionHandler {
    ...
    public ProblemDetail handleException(CustomerNotFoundException ex) {
        return build(HttpStatus.NOT_FOUND, ex, problem -> {
            problem.setType(URI.create("http://example.com/problems/customer-not-fond"));
