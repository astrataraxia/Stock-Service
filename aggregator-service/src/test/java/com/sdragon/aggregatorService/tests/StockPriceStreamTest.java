...
public class StockPriceStreamTest extends AbstractIntegrationTest{
    ...
    public void priceStream() {
        ...
        this.client.get()
                ...
                .assertNext(p -> Assertions.assertThat(p.price()).isEqualTo(53))
                .assertNext(p -> Assertions.assertThat(p.price()).isEqualTo(54))
                .assertNext(p -> Assertions.assertThat(p.price()).isEqualTo(55))
                .verifyComplete();
    }}
